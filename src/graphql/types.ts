...
export type Scalars = {
    ...
    Address: { input: Types.Scalars['Address']['input']; output: Types.Scalars['Address']['output'] }
    BigInt: { input: Types.Scalars['BigInt']['input']; output: Types.Scalars['BigInt']['output'] }
    HexString: { input: Types.Scalars['HexString']['input']; output: Types.Scalars['HexString']['output'] }
    MarketId: { input: Types.Scalars['MarketId']['input']; output: Types.Scalars['MarketId']['output'] }
}
...
export type Unnamed_1_Query = {
    ...
    markets: {
        ...
        items: Array<{
            ...
            loanAsset: { __typename?: 'Asset'; address: Types.Scalars['Address']['output']; symbol: string; decimals: number }
            collateralAsset: { __typename?: 'Asset'; address: Types.Scalars['Address']['output']; symbol: string; decimals: number } | null
            state: {
                __typename?: 'MarketState'
                borrowApy: number
